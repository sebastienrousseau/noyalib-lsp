...
# Developing noyalib-lsp

noyalib-lsp is a satellite of the [noyalib](https://github.com/sebastienrousseau/noyalib)
...
```bash
git clone https://github.com/sebastienrousseau/noyalib-lsp
cd noyalib-lsp
cargo test
```
