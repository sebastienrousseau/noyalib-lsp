...
`noyalib-lsp` releases in strict lockstep with `noyalib`. Version 0.0.52 pins
...
LSP methods, capability declarations, diagnostic codes, edit semantics, and
command-line behaviour are public. During `0.0.x`, the patch component is the
breaking axis.
